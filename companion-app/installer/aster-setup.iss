...
Source: "..\dist\host-manifest.json"; DestDir: "{app}"; Flags: ignoreversion
...
[Run]
Filename: "{app}\aster-companion-app-win.exe"; Description: "Executar Aster Companion agora"; Flags: postinstall nowait skipifsilent
